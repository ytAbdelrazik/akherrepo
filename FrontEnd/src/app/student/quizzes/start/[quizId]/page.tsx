  ...
  const fetchQuiz = async () => {
    try {
      ...
      if (err.response?.status === 409) {
        alert('You already started this quiz. Redirecting to your answers...');
        router.push(`/student/quizzes/results/${quizId}`); // Redirect to quiz results
      } else {
  ...
  const handleSubmit = async () => {
    try {
        ...
        if (err.response?.status === 409) {
          ...
          alert('You already took this quiz. Redirecting to your answers...');
